					...
					<div class="grid clearfix">
						...
						<div class="list_wrap pl_40">
							...
							<ul>
								...
								<li>우수도우미는 예약제로 운영됩니다. 이용하실경우 2~3 이전에 예약 해주시기 바랍니다.</li>
					...
					<div class="grid mt_100 clearfix">
						<div class="list_wrap pr_40">
							...
							<ul>
								...
								<li>인원부족 시작부족일때 부분적인 청소가 가능합니다.</li>
					...
					<div class="grid mt_100 clearfix">
						...
						<div class="list_wrap pl_40">
							...
							<ul>
								...
								<li>가정에서 많으 양의 김치를 담궈야 할 경우 도와드립니다.</li>
								<li>식당이나 공장등 많은 양의 김치를 필요로 담궈야 할 경우 도와드립니다.</li>
                    ...
                    <div class="grid mt_100 clearfix">
                        <div class="list_wrap pr_40">
                            ...
                            <ul>
                                ...
                                <li>말동무가 더불어 친구를 해드리고 산책도 함께 합니다.</li>
                    ...
                    <div class="grid mt_100 clearfix">
                        ...
                        <div class="list_wrap pr_40">
                            ...
                            <ul>
                                ...
                                <li>주방보조 : 주방에서 보조기능인이로서 설겆이를 함께하며 주방장과 찬모의 보조를 한다.</li>
