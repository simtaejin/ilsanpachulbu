					...
					<div class="_tbl">
						...
						<div class="cell2_pd">
							...
							<ul class="guin_list mt_30">
								<li class="guin_txt_2">A. 예약 시 미리 예약해 주시면 더욱 편리하게 서비스를 이용하실 수 있습니다.</li>
								<li class="guin_txt_2">B. 당사는 신원이 확인된 회원들로 등록된 도우미분들로 구성되어 있습니다.</li>
								<li class="guin_txt_2">C. 도우미 교체 필요시에 원하는 날짜에 교체 가능합니다.</li>
								<li class="guin_txt_2">D. 업무량이 사전의 협의된 시간내에 정해진 일을 다 할 수 없는 경우가 생기지 않도록<br>고객님의 많은 협조와 이해를 부탁드립니다.</li>
								<li class="guin_txt_2">E. 문제 발생 시 바로 당사로 연락을 주시면 친절하고 신속하게 상담하여 불편하신 부분을 해결하여 드리도록 하겠습니다.</li>
								<li class="guin_txt_2">F. 일산 여성 파출부는 최고의 서비스로 고객님을 모시도록 하겠습니다.</li>
								<!-- <li class="guin_txt_2">9. 고객님께서 당사의 회원인 도우미를 이용하시는 중에 도우미가 당사의 구직활동을 중단하게 될 수가 있으므로, 이런 경우 <br>
								여러가지 문제가 발생할 수 있으니 반드시 당사를 통하여 도우미분 서비스를 이용해 주시길 부탁 드립니다. 또한 이용하시던 <br>
								도우미분도 현재 정상적으로 당사에 구직회원으로 등록되어 활동하는 도우미인가 확인후 이용해 주시길 부탁 드립니다.</li>
								<li class="guin_txt_2">10. 당사는 회원제로 운영하고 있습니다. 정회원기간은 1년 입니다. 아울러 서비스를 계속 이용하기 위해서는 회원기간 만료시 <br>
								다시 정회원으로 등록 하시고 이용해 주시길 부탁드립니다.</li>
								<li class="guin_txt_2">11. 고객님댁 대부분이 정상적인 절차에 의한 도우미분 서비스를 받고 계십니다. <br>
								간혹 고객님과 도우미와의 직접거래를 하시는 경우 많은 어려움을 겪고 있으니 당사를 통한 정상적인 절차에 의한 <br>
								도우미분 서비스를 받을수 있도록 변함없는 협조를 부탁 드려봅니다.</li>
								<li class="guin_txt_2">12. 당사는 도우미분의 신원이 확인되고 구직자로서 회원등록 절차를 마친 도우미분들을 고객님 댁에 보내 드리고 있습니다.</li>
								<li class="guin_txt_2">13. 도우미와의 문제점 발생시 언제라도 회사로 연락주시면 친철하게 상담해 드리도록 하겠습니다.</li>
								<li class="guin_txt_2">14. 고객님댁에서 도우미분이 구직활동중 불미스러운 일이 생길 경우 신원을 확인해 드리고 있습니다. <br>
								( * 다만 직접거래시에는 신원확인을 해드리지 않습니다.)</li>
								<li class="guin_txt_2">15. 일산파출부는 고객님댁에 보다 나은 서비스를 하기 위하여 언제나 최선의 노력을 하도록 하겠습니다.</li>
								<li class="guin_txt_2">16. 당사는 보증보험에 가입되어 있습니다. 그밖에 문제점 발생시 관련 법률과 관습 또는 일반적인 상식에 준합니다.</li> -->
							</ul>
						</div>
					</div>
				</div>
