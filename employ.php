...
<!--							도우미는 여러분의 일을 도와드리는 가족입니다. 가족에게 폭언과 상처를 주시는 일을 없도록 부탁드립니다.</p>-->
							<ul class="guin_list mt_30">
								...
								<li class="guin_txt_2">4. 도우미가 일하는 근무 중에 물건이 파손되거나 도우미의 부주의로 인한 사고 발생시 도우미 책임하에 처리되어야 합니다.</li>
								<li class="guin_txt_2">5. 도우미와 업무 외에 어떠한금으로 금전거래도 하셔서는 안됩니다.</li>
								<li class="guin_txt_2">6. 도우미의 서비스 요금은 서비스가 끝난 후 지급하셔야 하며 미리 선불을 지급하는 일이 없도록 해 주시길 부탁드립니다.<br>&nbsp;&nbsp;&nbsp;선불의 경우 당사는 책임이 없음을 알려드립니다.</li>
								<li class="guin_txt_2">7. 도우미에게 의료 행위를 부탁하여서는 아니되십니다. 어떠한 경우에도 의료 행위는 할 수 없음을 알려드립니다.</li>
								<li class="guin_txt_2">8. 도우미 방문시 일의양이나 종류가 많아 최선을 다한다 하더라도 정해진 시간내에 하고져 하는 일을 다할 수 없는 경우도<br>&nbsp;&nbsp;&nbsp;있을 수 있으므로 적정량의 업무가 될 수 있도록 고객님의 많은 협조와 이해를 부탁드립니다.</li>
								<li class="guin_txt_2">9. 고객님댁의 도우미 방문시 주의하여 해야할 의류세탁, 가전제품, 그릇, 가구등등 그밖의 여러가지<br>&nbsp;&nbsp;&nbsp;조심스럽게 알고 다뤄야 하는 부분의 사용방법 등을 반드시 도우미분께 설명해 주셔야 합니다.<br>&nbsp;&nbsp;&nbsp; 만일 설명을 듣지 못한 경우 예기치 못한 사고가 발생 할수 있으니 안전한 서비스를 위하여 미리 알려 주시기 바랍니다.</li>
								<li class="guin_txt_2">10. 고객님께서 당사의 회원인 도우미를 이용하시는 중에 도우미가 당사의 구직활동을 중단하게 될 수가 있으므로,<br>&nbsp;&nbsp;&nbsp;이런 경우 여러가지 문제가 발생할 수 있으니 반드시 당사를 통하여 도우미분 서비스를 이용해 주시길 부탁드립니다.<br>&nbsp;&nbsp;&nbsp;또한 이용하시던 도우미분도 현재 정상적으로 당사에 구직회원으로 등록되어 활동하는 도우미인가 확인 후 이용해<br>&nbsp;&nbsp;&nbsp;주시길 바랍니다.</li>
								<li class="guin_txt_2">11. 당사는 회원제로 운영하고 있습니다. 정회원기간은 1년 입니다. 아울러 서비스를 계속 이용하기 위해서는 회원기간 만료시<br>&nbsp;&nbsp;&nbsp; 다시 정회원으로 등록 하시고 이용해 주시길 부탁드립니다.</li>
								<li class="guin_txt_2">12. 고객님댁 대부분이 정상적인 절차에 의한 도우미분 서비스를 받고 계십니다. 간혹 고객님과 도우미와의 직접거래를 하실<br>&nbsp;&nbsp;&nbsp; 경우 많은 어려움을 겪고 있으니 당사를 통한 정상적인 철차에 의한 도우미분 서비스를 받을 수 있도록 변함없는 협조를<br>&nbsp;&nbsp;&nbsp; 부탁 드려봅니다.</li>
								<li class="guin_txt_2">13. 당사는 도우미분의 신원이 확인되고 구직자로서 회원등록 절차를 마친 도우미분들을 고객님 댁에 보내 드리고 있습니다.</li>
								<li class="guin_txt_2">14. 도우미와의 문제점 발생시 언제라도 회사로 연락주시면 친절하게 상담해 드리도록 하겠습니다.</li>
								<li class="guin_txt_2">15. 고객님댁에서 도우미분이 구직활동중 불미스러운 일이 생길 경우 신원을 확인해 드리고 있습니다.<br>&nbsp;&nbsp;&nbsp;다만 직접거래시에는 신원확인을 해드리지 않습니다.</li>
...
제7조 회사는 1년간 서비스를 이용하지 않은 이용자에게 사전통지하고 개인정보를 파기<br>
		...
		</div> 			<a href="employ.php#" class="btn_top"></a>			<script>
				(function() {
