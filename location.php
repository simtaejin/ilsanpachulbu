...
<html lang="ko"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <script type="text/javascript" src="./assets/slick.min.js"></script><link rel="stylesheet" href="./assets/roughmapLander.css"><script src="./assets/v3.js"></script><script src="./assets/v3(1).js"></script></head>
<body>
    <div id="skipNavi">
    ...
    <div id="wrap">
            ...
            <div class="top">
                <div class="inner">
                    <ul>
                        <li><a class="btn_use" href="location.php#">이용약관</a></li>
                        <li><a class="col_1d6 btn_info" href="location.php#">개인정보처리방침</a></li>
...
제7조 회사는 1년간 서비스를 이용하지 않은 이용자에게 사전통지하고 개인정보를 파기<br>
		...
		</div> 			<a href="location.php#" class="btn_top"></a>			<script>
				(function() {
