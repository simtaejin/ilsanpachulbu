<!DOCTYPE html>
<!-- saved from url=(0051)location.php -->
<html lang="ko">
<head>
    ...
    <link rel="stylesheet" href="./assets/roughmapLander.css">
    <script src="./assets/v3.js"></script>
    <script src="./assets/v3(1).js"></script>
</head>
<body>
<div id="skipNavi">
    <a href="location.php#container">본문바로가기</a>
</div>
<div id="wrap">
    <header id="header">
        ...
        <div class="bottom">
            <div class="inner">
                <ul class="gnb">
                    ...
                    <li class="on"><a href="location.php">찾아오시는 길</a></li>
    ...
    <main id="container" class="sub">
        ...
        <section class="contents">
            <div class="inner ">
                ...
                <div class="location_info mt_60 clearfix">
                    <div class="fl_l" style="width: calc(100% - 585px);">
                        <dl>
                            <dt><span class="bl_label">주소</span></dt>
                            <dd class="ml_10">경기도 고양시 일산 서구 대화동 2223번지 삼운트루아 612호<br>
                                <!--									<span class="small">구주소 : 경기도 고양시 일산구 주엽동 109번지 화성플라자 314호</span>-->
                            </dd>
                        </dl>
                        <dl class="mt_30">
                            <dt><span class="bl_label">TEL</span></dt>
                            <dd class="ml_10">031-922-0025
                            </dd>
                        </dl>
                    </div>
                    <div class="fl_l" style="width: 585px;">
                        <!--							<img src="./images/location_1.jpg" alt="건물전경">-->
                    </div>
                </div>
            </div>
        </section>
    ...
    <a href="location.php#" class="btn_top"></a>
    <script>
        (function () {
            $(".gnb > li:nth-child(7)").addClass("on");
            $(".gnb > li:nth-child(7)").removeClass("off").siblings("li").addClass("off");
        })();
    </script>
</div>
