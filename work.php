...
<body>
    <div id="skipNavi">
        <a href="work.php#container">본문바로가기</a>
    </div>
    <div id="wrap">
       		<header id="header">
            ...
            <div class="bottom">
                <div class="inner">
                    ...
                    <li class="off">
                        ...
                        <li class="on"><a href="work.php">구직회원</a></li>
            ...
            <section class="visual">
				<div class="inner">
					<!-- <h2 class="tit">구직회원</h2> -->
				</div>
            </section>
            <section class="contents">
				<div class="inner">
					<div class="_tbl">
						<div class="img"><img src="./images/gujik_inform.jpg" alt="구직이미지"></div>
						<div class="cell2_pd">
							<h3 class="gujik_tit">구직회원 안내</h3>
...
제7조 회사는 1년간 서비스를 이용하지 않은 이용자에게 사전통지하고 개인정보를 파기<br>
		...
		</div> 			<a href="work.php#" class="btn_top"></a>			<script>
				(function() {
					$(".gnb > li:nth-child(6)").addClass("on");
					$(".gnb > li:nth-child(6)").removeClass("off").siblings("li").addClass("off");
				})();
			</script>
    </div>
